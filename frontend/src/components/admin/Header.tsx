      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          {onBack && (
            <button
              onClick={onBack}
              className="flex items-center space-x-2 px-4 py-2 text-[var(--color-primary)] hover:bg-yellow-50 rounded-lg transition-colors duration-200 border border-yellow-200"
            >
              <ArrowLeft size={18} />
