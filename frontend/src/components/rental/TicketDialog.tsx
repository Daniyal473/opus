...
export function TicketDialog({ ticket, isOpen, onClose, onUpdate, ticketOptions = [], maintenanceOptions = [], agentOptions = [], role }: TicketDialogProps) {
    ...
    }, [isOpen, ticket?.id]); // Only reset when opening or switching to a DIFFERENT ticket ID
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            ...
            if (Object.keys(editForm).length > 0) {
                promises.push(updateTicket(ticket.teableId, editForm));
            }
