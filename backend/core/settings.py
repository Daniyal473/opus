...
TEABLE_USER_TABLE_URL = os.getenv('TEABLE_USER_TABLE_URL')
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-2qm!+a6ox971oehc(_n4tx++^j@=9!e0nncp*a4$(jb9!1k+v2')
...
# Increase max upload size to 25MB
